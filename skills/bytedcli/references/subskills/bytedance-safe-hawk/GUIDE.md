---
name: bytedance-safe-hawk
description: Hawk platform operations via bytedcli safe domain. Use when the user wants to query Hawk scene metadata (services, scopes, scenes), list Hawk ops entries for an object, or get Hawk ops detail info for a specific log entry. Also use for 中文意图：Hawk 平台、Hawk 场景、Hawk 服务、Hawk ops、Hawk 操作记录、Hawk 操作详情.
---
