...
```bash
bytedcli lark slides xml_presentation.slide create --as user --params '<json_params>' --data '<json_data>'
```
...
1. **执行前必做**: 使用 `bytedcli lark schema slides.xml_presentation.slide.create` 查看最新的参数结构
