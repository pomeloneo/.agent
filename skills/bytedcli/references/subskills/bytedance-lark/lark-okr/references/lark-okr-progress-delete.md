...
```bash
# 删除指定 ID 的进展记录
bytedcli lark okr +progress-delete --progress-id 1234567890123456789

# 预览 API 调用而不实际执行
bytedcli lark okr +progress-delete --progress-id 1234567890123456789 --dry-run
```
...
2. 执行 `bytedcli lark okr +progress-delete --progress-id "1234567890123456789"`。
3. 报告结果：已删除的进展记录 ID。
