...
bytedcli lark drive +push --local-dir ./repo --folder-token fldcnxxxxxxxxx
...
>
> 想一次性把权限补齐：`bytedcli lark auth login --scope "drive:drive.metadata:readonly drive:file:upload space:folder:create space:document:delete"`。
