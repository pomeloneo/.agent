...
bytedcli lark drive file.comment.replys list \
...
bytedcli lark drive file.comment.reply.reactions update_reaction \
  --params '{"file_token":"<DOC_TOKEN>","file_type":"docx"}' \
