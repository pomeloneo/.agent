...
> **前置条件：** 先阅读 [`../lark-shared/GUIDE.md`](../../lark-shared/GUIDE.md) 了解认证、权限处理和全局参数。
...
- `HelpFirst`: 参数、示例、JSON shape 和取值约束以 `bytedcli lark base +record-get --help`、`+record-search --help`、`+record-list --help` 为准。
