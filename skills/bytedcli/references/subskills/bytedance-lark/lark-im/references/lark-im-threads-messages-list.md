...
This skill maps to the shortcut: `bytedcli lark im +threads-messages-list` (internally calls `GET /open-apis/im/v1/messages` with `container_id_type=thread` to fetch thread messages).
...
bytedcli lark im +threads-messages-list --thread omt_xxx --sort desc

# Control page size
bytedcli lark im +threads-messages-list --thread omt_xxx --page-size 20

# Pagination
bytedcli lark im +threads-messages-list --thread omt_xxx --page-token <PAGE_TOKEN>

# Output format options
bytedcli lark im +threads-messages-list --thread omt_xxx --format pretty
bytedcli lark im +threads-messages-list --thread omt_xxx --format table
bytedcli lark im +threads-messages-list --thread omt_xxx --format csv

# View as a bot
bytedcli lark im +threads-messages-list --thread omt_xxx --as bot

# Preview the request without executing it
bytedcli lark im +threads-messages-list --thread omt_xxx --dry-run
```
