...
This skill maps to the shortcut: `bytedcli lark im +messages-mget` (internally calls `GET /open-apis/im/v1/messages/mget`).

## Commands

```bash
# Fetch a single message
bytedcli lark im +messages-mget --message-ids om_xxx

# Fetch multiple messages in batch (comma-separated)
bytedcli lark im +messages-mget --message-ids "om_aaa,om_bbb,om_ccc"

# JSON output
bytedcli lark im +messages-mget --message-ids "om_aaa,om_bbb" --format json

# Preview the request without executing it
bytedcli lark im +messages-mget --message-ids "om_aaa" --dry-run
```
...
```bash
bytedcli lark im +messages-mget --message-ids om_xxx --format json
```
...
bytedcli lark im +messages-mget --message-ids "om_aaa,om_bbb"
```
