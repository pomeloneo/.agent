...
```bash
bytedcli lark schema im.reactions
bytedcli lark schema im.reactions.create --format pretty
bytedcli lark schema im.reactions.list --format pretty
bytedcli lark schema im.reactions.delete --format pretty
```

If your local build has already exposed the batch API in `schema`, also check:

```bash
bytedcli lark schema im.reactions.batch_query --format pretty
```
...
```bash
bytedcli lark im reactions create \
...
```bash
bytedcli lark im reactions list --params '{"message_id":"om_xxx"}'
bytedcli lark im reactions list --params '{"message_id":"om_xxx","reaction_type":"SMILE"}'
bytedcli lark im reactions list --params '{"message_id":"om_xxx","page_size":50}'
bytedcli lark im reactions list --params '{"message_id":"om_xxx","page_token":"<PAGE_TOKEN>"}'
bytedcli lark im reactions list --params '{"message_id":"om_xxx","user_id_type":"open_id"}'
```
...
```bash
bytedcli lark im reactions delete \
...
```bash
bytedcli lark im reactions batch_query \
