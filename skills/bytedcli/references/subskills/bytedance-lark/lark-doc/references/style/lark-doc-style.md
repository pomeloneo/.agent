...
> **提醒：** `docs +update` 不能编辑已有画板内容；下面的语法都是**新增**画板块。修改已有画板需切到 [`lark-whiteboard`](../../../lark-whiteboard/GUIDE.md)。
...
3. 切到 [`lark-whiteboard`](../../../lark-whiteboard/GUIDE.md) skill 设计并上传 DSL
