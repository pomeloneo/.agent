...
```bash
# 简单文本替换
bytedcli lark docs +update --api-version v2 --doc "<doc_id>" --command str_replace \
...
```bash
bytedcli lark docs +update --api-version v2 --doc "<doc_id>" --command block_insert_after \
...
```bash
bytedcli lark docs +update --api-version v2 --doc "<doc_id>" --command block_replace \
  --block-id "目标 block_id" \
...
```bash
bytedcli lark docs +update --api-version v2 --doc "<doc_id>" --command block_delete \
  --block-id "目标 block_id"
```
...
```bash
bytedcli lark docs +update --api-version v2 --doc "<doc_id>" --command overwrite \
...
```bash
bytedcli lark docs +update --api-version v2 --doc "<doc_id>" --command append \
...
bytedcli lark docs +update --api-version v2 --doc "<doc_id>" --command block_copy_insert_after \
...
```bash
# 移动到页面末尾
bytedcli lark docs +update --api-version v2 --doc "<doc_id>" --command block_move_after \
...
1. **获取文档内容和 block ID**：
   ```bash
   bytedcli lark docs +fetch --api-version v2 --doc "<doc_id>" --detail with-ids
   ```
