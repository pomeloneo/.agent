...
```bash
# 获取文档（默认 XML，simple）
bytedcli lark docs +fetch --api-version v2 --doc "https://xxx.feishu.cn/docx/Z1Fj...tnAc"

# Markdown 格式
bytedcli lark docs +fetch --api-version v2 --doc Z1Fj...tnAc --doc-format markdown

# 带 block ID（用于后续 block 级更新）
bytedcli lark docs +fetch --api-version v2 --doc Z1Fj...tnAc --detail with-ids

# 只拿目录
bytedcli lark docs +fetch --api-version v2 --doc Z1Fj...tnAc --scope outline --max-depth 3

# 按 block id 区间精读
bytedcli lark docs +fetch --api-version v2 --doc Z1Fj...tnAc \
