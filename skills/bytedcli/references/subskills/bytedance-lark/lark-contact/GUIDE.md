...
bytedcli lark contact +search-user --query "张三" --has-chatted --as user
bytedcli lark im +messages-send --user-id ou_xxx --text "Hi!"
```
...
- 部门树 / 按部门列员工 / 组织架构 ,通过 [`lark-openapi-explorer`](../lark-openapi-explorer/GUIDE.md) 查找原生接口
