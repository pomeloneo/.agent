...
```bash
# 取自己
bytedcli lark contact +get-user --as user

# bot 按 ID 取他人
bytedcli lark contact +get-user --user-id ou_xxx --as bot

# 按 union_id / user_id 取(默认 open_id)
bytedcli lark contact +get-user --user-id <id> --user-id-type union_id --as bot
```
