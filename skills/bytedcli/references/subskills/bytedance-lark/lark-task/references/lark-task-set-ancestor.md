...
```bash
# Set a parent task
bytedcli lark task +set-ancestor --task-id "guid_1" --ancestor-id "guid_2"

# Clear the parent task
bytedcli lark task +set-ancestor --task-id "guid_1"
```
...
2. Execute `bytedcli lark task +set-ancestor ...`
