...
bytedcli lark task +reminder --task-id "<task_guid>" --set "30"

# Set a reminder (e.g., 1 hour before due)
bytedcli lark task +reminder --task-id "<task_guid>" --set "1h"

# Remove all reminders
bytedcli lark task +reminder --task-id "<task_guid>" --remove "true"
```
