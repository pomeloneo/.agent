...
bytedcli lark task +get-my-tasks --query "Lobster No. 1"
...
bytedcli lark task +get-my-tasks --complete=false

# Fetch all my tasks (up to 40 pages)
bytedcli lark task +get-my-tasks --page-all

# Fetch up to 10 pages
bytedcli lark task +get-my-tasks --page-limit 10

# Resume from a known page token
bytedcli lark task +get-my-tasks --page-token "pt_xxx"
```
