...
```bash
# Search by keyword
bytedcli lark task +tasklist-search --query "测试"

# Search tasklists created by specific users
bytedcli lark task +tasklist-search --creator "ou_xxx,ou_yyy"

# Search by creation time range
bytedcli lark task +tasklist-search --query "Q2" --create-time "-30d,+0d"
```
...
2. Execute `bytedcli lark task +tasklist-search ...`
