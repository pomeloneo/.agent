...
```bash
# Add a member
bytedcli lark task +tasklist-members --tasklist-id "tl_xxx" --add "ou_aaa"

# Remove a member
bytedcli lark task +tasklist-members --tasklist-id "tl_xxx" --remove "ou_aaa"

# Replace all members exactly
bytedcli lark task +tasklist-members --tasklist-id "tl_xxx" --set "ou_aaa,ou_bbb"
```
