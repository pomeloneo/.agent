...
```bash
bytedcli lark auth login --domain calendar,task
```
...
bytedcli lark calendar +agenda --start "2026-03-26T00:00:00+08:00" --end "2026-03-26T23:59:59+08:00"
```
...
bytedcli lark task +get-my-tasks

# 只看指定日期前到期的（推荐用于摘要场景，减少数据量）
bytedcli lark task +get-my-tasks --due-end "2026-03-27T23:59:59+08:00"

# 获取全部（超过 20 条时）
bytedcli lark task +get-my-tasks --page-all
```
